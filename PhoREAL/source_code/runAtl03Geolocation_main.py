...
outFilePath = 'N:/USERS/mike/iceSat2/atl03_validation/r002_ncarolina_20181018_test' # WSMR r002
...
truthSwathDir = 'z:/data/validation/data/NorthCarolina/LAS_UTM2'
...
useMeasSigConf = True             # Use measured signal confidence (or use ground truth)
                                 # ICESat-2 ATL03 Classes (0 = Unclass, 1 = Ground, 2 = Low Veg, 3 = High Veg), Texpert Truth Classes (0 = Unclass, 2 = Ground, 4 = Veg, 6 = Building)
